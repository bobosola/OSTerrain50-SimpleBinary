...
pub const OUTPUT_FILE_NAME: &str       = "OSTerrain50.bin"; // The name of the output file
...
// The 91 100km² grids from W to E and S to N. Note that the character "I" is not used.
// See http://en.wikipedia.org/wiki/Ordnance_Survey_National_Grid for full explanation.
